...
public class MyFrame extends JFrame {
    ...
    public MyFrame() {
        ...
        // 添加菜单栏目录
        // 实例化菜单栏目录
        JMenu menu1 = new JMenu("Game Menu");
        ...
        // 将“模式”菜单添加到“设置”里面
        JMenu menu4 = new JMenu("Game Mode");
        menu2.add(menu4);

        // 设置“”目录下面的子目录
        JRadioButtonMenuItem item1 = new JRadioButtonMenuItem("P VS P");
        JRadioButtonMenuItem item2 = new JRadioButtonMenuItem("P VS C");
        // item1按钮添加时间并且为匿名类
        ...
        // 游戏难度设置
        JRadioButtonMenuItem item5 = new JRadioButtonMenuItem("傻瓜");
